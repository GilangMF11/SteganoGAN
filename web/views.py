...
# gen = pickle.load(open('generator.hs'))
# desk = pickle.load(open('decriminator.h5'))
# mnist = pickle.load(open('minst_model.h5'))
...
def index():
    ...
    # gene = gen.predict([[array(data['exp'])]])
    # deskri = desk.predict([[array(data['exp'])]])
    # mnis = mnist.predict([[array(data['exp'])]])
    # out = gen[0]
    # return jsonify(out)
